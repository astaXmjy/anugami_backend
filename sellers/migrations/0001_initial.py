    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('Prepaid', 'Prepaid'), ('COD', 'Cash on Delivery')], max_length=10)),
                ('order_status', models.CharField(choices=[('pending', 'Pending'), ('processed', 'Processed'), ('shipped', 'Shipped'), ('delivered', 'Delivered'), ('cancelled', 'Cancelled')], default='pending', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotional_codes', models.JSONField(blank=True, default=dict, null=True)),
                ('shipping_methods', models.JSONField(blank=True, default=dict, null=True)),
                ('shipping_days', models.JSONField(blank=True, default=dict, null=True)),
